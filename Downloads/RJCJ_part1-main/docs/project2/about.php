...
<main class="container">
    <section>
      ...
      <h3 class="section-subtitle">💡 Project Ideas</h3>
      <ul>
      ...
      <h3 class="section-subtitle">🎓 Tutor</h3>
      ...
      <h3 class="section-subtitle">🎵 Members' Interests</h3>
      ...
      <h3 class="section-subtitle">🧠 Group Profile</h3>
